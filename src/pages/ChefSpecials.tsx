...
import { Quote, Flame, Clock } from 'lucide-react';
        ...
        {chefSpecials.map((special, index) => (
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              ...
              <div className="text-brand-gold/70 text-sm font-medium italic mt-auto flex justify-end">
                * Please ask your server to order this item
              </div>
            </div>
          </motion.div>
        ))}
